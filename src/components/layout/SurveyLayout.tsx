...
function SurveyLayout({ children }: LayoutInterface) {
  // const { state } = useAppContext();

  return (
    <div className="grid grid-cols-[400px_auto] h-screen relative overflow-hidden bg-white ">
      ...
      <main className="flex flex-col h-screen overflow-hidden relative z-10">
        <header className="py-3 px-[4%] border-b flex justify-between items-center">
          <Link to={"/survey"} className=" w-[120px]">
